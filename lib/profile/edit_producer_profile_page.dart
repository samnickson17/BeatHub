...
class EditProducerProfilePage extends StatefulWidget {
  final ProducerProfile profile;

  const EditProducerProfilePage({
    super.key,
    required this.profile,
  });

  @override
  State<EditProducerProfilePage> createState() => _EditProducerProfilePageState();
}

class _EditProducerProfilePageState extends State<EditProducerProfilePage> {
  ...
  void _save() {
    ...
    ProducerProfileStore.saveProfile(
