...
class _BeatDetailPageState extends State<BeatDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final isArtistUser = AppBackend.auth.currentUser?.role == AppUserRole.buyer;
    final selectedPrice = beat.priceForLicense(_selectedLicense);

    return Scaffold(
      appBar: AppBar(title: const Text("Beat Details"), centerTitle: true),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              Text(
                "Premium Price: Rs ${beat.premiumLicensePrice.toStringAsFixed(0)}",
              ),
              Text(
                "Exclusive Price: Rs ${beat.exclusiveLicensePrice.toStringAsFixed(0)}",
              ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      final buyerProfile = ProfileStore.getProfile(
